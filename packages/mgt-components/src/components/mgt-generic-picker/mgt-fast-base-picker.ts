...
import { ComponentMediaQuery, LocalizationHelper, Providers, ProviderState } from '@microsoft/mgt-element';
import { PropertyValues } from 'lit-element';

/**
 * Base picker from FAST with MGT functionality.
 */
export class MgtGenericPickerBase extends Picker {
  /**
  ...
  protected firstUpdated(changedProperties): void {
    ...
    // TODO: fix by checking the connectedCallback
  ...
  protected updated(changedProperties: PropertyValues) {
    ...
    // TODO: Fix for updating the properties. Call attributeChangedCallback?
